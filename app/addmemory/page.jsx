                        ...
                        <div className="p-8 bg-gray-500 rounded-xl">
                            <div className="flex flex-wrap items-center justify-between -mx-4 mb-8 pb-6 border-b border-gray-400 border-opacity-20">
                                <div className="w-full sm:w-auto px-4 mb-6 sm:mb-0">
                                    <h4 className="text-2xl font-bold tracking-wide text-white mb-1">Add Memory</h4>
                                    <p className="text-sm text-gray-300">Brief </p>
                                </div>
                                <div className="w-full sm:w-auto px-4">
                                    <div>
                                    <a className="inline-block py-2 px-4 text-xs text-center font-semibold leading-normal text-blue-50 bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-200" href="#" onClick={() => {
                                    ...
                                    <div className="max-w-xl">
                                        <div className="flex flex-wrap items-center -mx-3">
                                            <div className="w-full sm:w-1/2 px-3 mb-3 sm:mb-0">
                                                <input className="block py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" type="text" onChange={handleOnChange} name="name" value={data.name} placeholder="Memory Title aka abstract" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                <div className="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                                    <span className="text-sm font-medium text-gray-100">Social Handle</span>
                                </div>
                                <div className="w-full sm:w-2/3 px-4">
                                    <div className="max-w-xl">
                                        <input className="block py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" type="text" onChange={handleOnChange} name="handle" value={data.handle} placeholder="scor32k " title="If anonymouss leave blank" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                ...
                                <div className="w-full sm:w-2/3 px-4">
                                    <div className="max-w-xl">
                                        <input className="block py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" type="text" onChange={handleOnChange} name="password" value={data.password} placeholder="jgjgUUITUI632746JBASa" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                <div className="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                                    <span className="text-sm font-medium text-gray-100">Mood</span>
                                </div>
                                <div className="w-full sm:w-2/3 px-4">
                                    <div className="max-w-xl">
                                        <div className="relative block px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                            ...
                                            <select className="w-full py-4 appearance-none bg-transparent outline-none" id="formInput1-6" onChange={handleOnChange} name="mood" value={data.mood}>
                            ...
                            <div className="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                <div className="w-full sm:w-1/3 px-4 mb-5 sm:mb-0">
                                    <span className="block mt-2 text-sm font-medium text-gray-100">Description</span>
                                    <span className="text-xs text-gray-400">Description about the Memory</span>
                                </div>
                                <div className="w-full sm:w-2/3 px-4">
                                    <div className="max-w-xl"><textarea className="block h-56 py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg resize-none" id="formInput1-9" type="text" onChange={handleOnChange} name="desc" placeholder="desc" value={data.desc}></textarea>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                    ...
                                    <div className="flex flex-wrap sm:flex-nowrap max-w-xl">
                                        ...
                                        <div className="w-full py-8 px-4 text-center border-dashed border border-gray-400 hover:border-white focus:border-green-500 rounded-lg">
                                            <div className="relative group h-14 w-14 mx-auto mb-4">
                                                ...
                                                <input className="absolute top-0 left-0 h-14 w-14 opacity-0" accept="image/*"
                                                    type="file"
                            ...
                            {/* <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                    ...
                                    <div className="w-full sm:w-2/3 px-4">
                                        <div className="max-w-xl">
                                            <input className="block py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" id="formInput1-5" type="text" placeholder="Frontend Developer"/>
                                        </div>
                                    </div>
                                </div> */}
                                    ...
                                    <div className="w-full sm:w-2/3 px-4">
                                        <div className="max-w-xl">
                                            <div className="relative block px-3 w-full text-sm font-medium border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                ...
                                                <select className="w-full py-4 text-gray-50 placeholder-gray-50 appearance-none bg-transparent outline-none" id="formInput1-7" name="">
                                                    <option className="bg-gray-500" value="1">Central Daylight Time (GMT-5) UTC-08:00</option>
                                                    <option className="bg-gray-500" value="1">Central Daylight Time (GMT-5) UTC-08:00</option>
                                                    <option className="bg-gray-500" value="1">Central Daylight Time (GMT-5) UTC-08:00</option>
                                                </select>
                                            </div>
                            ...
                            {/* <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                                    ...
                                    <div className="w-full sm:w-2/3 px-4">
                                        <div className="max-w-xl">
                                            <input className="block py-4 px-3 w-full text-sm text-gray-50 placeholder-gray-50 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" id="formInput1-8" type="text" placeholder="trizzle.ui/shuffle"/>
                                        </div>
                                    </div>
                                </div> */}
